...
@RestController
@Slf4j
public class RushDealController {

    @Autowired
    private RushDealService rushDealService;
    ...
    public String query(@PathVariable() String productId){
        return rushDealService.queryRushDealProductInfo(productId);
    }
    ...
    public String skill(@PathVariable() String productId){
        ...
        rushDealService.orderProductMockDiffUser(productId);
        return rushDealService.queryRushDealProductInfo(productId);
    }
}
